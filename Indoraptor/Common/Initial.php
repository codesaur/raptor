...
class Initial
{
    ...
    // generated by codesaur - framework| 2020-10-29 15:16:16 | 202.179.27.179
    ...
    // table: templates
        ...
        $m->replaces(array('_keyword_' => 'approve-new-account', 'type' => 5, 'legend' => 1, 'status' => '1', 'created_at' => '2020-10-29 14:42:13', 'updated_at' => '2020-10-29 15:05:19'), array('mn' => array('title' => 'Хэрэглэгчийн бүртгэл баталгаажлаа', 'short' => '', 'full' => '<p>Сайн байна уу, эрхэм {@username}?</p><p>Таньд энэ өдрийн мэнд хүргэе!</p><p> </p><p>Таны бүртгэл баталгаажиж хэрэглэгч амжилттай үүслээ.</p><p>Та {@login} холбоос дээр дарж, өөрийн бүртгүүлсэн нууц үгээ ашиглан системд нэвтэрнэ үү.</p><p>Нэвтрэх нэр: <strong>{@username}</strong> эсвэл <strong>{@email}</strong></p><p> </p><p>Хүндэтгэсэн,</p><p>Хөгжүүлэгчдийн баг.</p>'), 'en' => array('title' => 'Хэрэглэгчийн бүртгэл баталгаажлаа', 'short' => '', 'full' => '<p>Сайн байна уу, эрхэм {@username}?</p><p>Таньд энэ өдрийн мэнд хүргэе!</p><p> </p><p>Таны бүртгэл баталгаажиж хэрэглэгч амжилттай үүслээ.</p><p>Та {@login} холбоос дээр дарж, өөрийн бүртгүүлсэн нууц үгээ ашиглан системд нэвтэрнэ үү.</p><p>Нэвтрэх нэр: <strong>{@username}</strong> эсвэл <strong>{@email}</strong></p><p> </p><p>Хүндэтгэсэн,</p><p>Хөгжүүлэгчдийн баг.</p>')));
    }
}
