...
{   
    public function index()
    {
        ...
        $card->addContent(new TwigTemplate(velociraptor_html . '/language/index-table.html'));

        $view->addDelete(array('logger' => 'localization', 'model' => 'Indoraptor\\Models\\Language'));
        ...
        try {
            ...
            if ($action == 'insert') {
                ...
                $countries = $this->indopost(
                        '/record/retrieve?model=' . \urlencode('Indoraptor\Models\Countries'),
                ...
                $response = $this->indopost('/record/retrieve?model='
                        . \urlencode('Indoraptor\\Models\\Language'), array('id' => $id));
            ...
            (new TwigTemplate(
                velociraptor_html . "/language/$action-modal.html",
                array(
    ...
    public function submit_insert()
    {
        ...
        try {
            ...
            $response = $this->indopost('/record?model='
                    . \urlencode('Indoraptor\\Models\\Language'), array('record' => $record));
            ...
            $retrieve = $this->indopost('/record/retrieve?model='
                    . \urlencode('Indoraptor\\Models\\Language'),
