...
class RBACController extends RaptorController
{
    ...
    public function index()
    {
        ...
        $organizations = single::link('crud', array('action' => 'index')) .
                '?logger=organization&controller=' . \urlencode('Velociraptor\\Controllers\\OrganizationController');
        ...
        $card->addContent(new TwigTemplate(
                velociraptor_html . '/rbac/rbac-index.html',
                array(
    ...
    public function crud(string $action)
    {
        try {
            ...
            (new TwigTemplate(velociraptor_html . "/rbac/rbac-crud-$action-$thing-modal.html", $vars))->render();
            ...
            if (isset($result['id'])) {
                if ($submit == 'submit_role_permission') {
                    ...
                    $result['href'] = single::link('crud', array('action' => 'index'))
                            . '?logger=account&controller=Velociraptor\\Controllers\\AccountController';
                } else {
                    $result['href'] = single::link('crud', array('action' => 'index'))
    ...
    public function orgIndex()
    {
        ...
        (new TwigTemplate(velociraptor_html . "/rbac/rbac-org-index.html", $vars))->render();
